    ...
    <div className="relative min-h-screen pb-28">
      <div className="mx-auto w-full max-w-[1680px] px-3 pt-3 sm:px-5 sm:pt-5 lg:px-7">
        <header className="glass-luxe edge-glow-violet flex items-center justify-between rounded-2xl px-4 py-3 sm:px-5">
          <Link
            href="/"
            className="group motion-hover-surface inline-flex items-center gap-3 rounded-full border border-transparent px-3 py-2 transition hover:border-[var(--card-border)] hover:bg-[color-mix(in_srgb,var(--accent)_12%,transparent)] focus-visible:border-[var(--card-border)] focus-visible:bg-[color-mix(in_srgb,var(--accent)_12%,transparent)]"
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden rounded-lg border border-white/16 bg-[color-mix(in_srgb,var(--surface-2)_82%,transparent)] px-3 py-1.5 text-xs font-semibold text-[var(--foreground)] sm:inline-flex">
              {userEmail}
            </div>
          </div>
        </header>

        <main className="mt-4 min-h-[calc(100vh-11rem)] rounded-3xl border border-white/14 bg-[color-mix(in_srgb,var(--surface)_75%,transparent)] p-3 shadow-[0_28px_60px_-42px_rgba(0,0,0,0.62)] backdrop-blur-sm sm:p-5">
      ...
      <nav className="pointer-events-none fixed inset-x-0 bottom-4 z-40 flex justify-center px-3 sm:bottom-5">
        <div className="pointer-events-auto flex items-center gap-1 rounded-2xl border border-white/16 bg-[color-mix(in_srgb,var(--surface-2)_84%,transparent)] px-2 py-2 shadow-[0_20px_45px_-28px_rgba(0,0,0,0.75)] backdrop-blur-xl sm:gap-2 sm:px-3">
          {navItems.map((item) => {
          ...
          <span className="mx-0.5 h-8 w-px bg-white/14 sm:mx-1" />
          ...
          <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/16 bg-[color-mix(in_srgb,var(--surface)_72%,transparent)] text-[var(--foreground)]">
